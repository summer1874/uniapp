...
var x=['./pages/home/index.wxml','./pages/login/index.wxml','./pages/receiving/details/index.wxml','./pages/receiving/index.wxml'];d_[x[0]]={}
...
var cF=_mz(z,'input',['class',1,'placeholder',1,'type',2,'value',3],[],e,s,gg)
_(fE,cF)
var hG=_mz(z,'input',['class',5,'placeholder',1,'type',2,'value',3],[],e,s,gg)
_(fE,hG)
var oH=_mz(z,'button',['disabled',-1,'class',9,'hoverClass',1,'loading',2,'type',3],[],e,s,gg)
