...
var x=['./pages/index/index.wxml','./pages/login/index.wxml','./pages/receiving/details/index.wxml','./pages/receiving/index.wxml','./style/photoSite/photoSite.wxml'];d_[x[0]]={}
...
var cF=_mz(z,'input',['placeholder',1,'type',1,'value',2],[],e,s,gg)
_(fE,cF)
var hG=_mz(z,'input',['placeholder',4,'type',1,'value',2],[],e,s,gg)
_(fE,hG)
var oH=_n('button')
_rz(z,oH,'type',7,e,s,gg)
...
_(eN,bO)
var oP=_mz(z,'button',['bindtap',2,'data-event-opts',1,'type',2],[],e,s,gg)
...
__wxAppCode__['style/photoSite/photoSite.wxss']=undefined;    
__wxAppCode__['style/photoSite/photoSite.wxml']=$gwx('./style/photoSite/photoSite.wxml');
